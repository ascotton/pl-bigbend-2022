...
SharrrePlatform.register("delicious", function (a) {
  return defaultSettings = {
  ...
  }, defaultSettings = $.extend(!0, {}, defaultSettings, a), {
    ...
    load: function (a) {
      if ("tall" == a.options.buttons.delicious.size) var b = "width:50px;",
          ...
          d = "height:18px;line-height:18px;margin-top:3px;";else var b = "width:93px;",
  ...
  return defaultSettings = {
    ...
    load: function (a) {
      var b = this.settings;
      $(a.element).find(".buttons").append('<div class="button googleplus"><div class="g-plusone" data-size="' + b.size + '" data-href="' + ("" !== b.url ? b.url : a.options.url) + '" data-annotation="' + b.annotation + '"></div></div>'), window.___gcfg = {
        lang: b.lang
      };
      var c = 0;
  ...
  return defaultSettings = {
    ...
    load: function (a) {
      var b = this.settings;
      $(a.element).find(".buttons").append('<div class="button pinterest"><a href="https://www.pinterest.com/pin/create/button/?url=' + ("" !== b.url ? b.url : a.options.url) + "&media=" + b.media + "&description=" + b.description + '" data-pin-do="buttonBookmark" count-layout="' + b.layout + '">Pin It</a></div>'), function () {
        var a = document.createElement("script");
        a.type = "text/javascript", a.async = !0, a.src = "https://assets.pinterest.com/js/pinit.js", a.setAttribute("data-pin-build", "parsePinBtns");
        var b = document.getElementsByTagName("script")[0];
        b.parentNode.insertBefore(a, b);
      }(), window.parsePinBtns && window.parsePinBtns(), $(a.element).find(".pinterest").on("click", function () {
  ...
  return defaultSettings = {
    ...
    load: function (a) {
      var b = this.settings,
          c = this;
      $(a.element).find(".buttons").append('<div class="button reddit"><a href="https://www.reddit.com/submit?url=' + ("" !== b.url ? b.url : a.options.url) + '"><img src="https://www.redditstatic.com/spreddit7.gif" alt="submit to reddit" border="0" /></a></div>'), $(a.element).find(".reddit").on("click", function () {
        c.popup(a.options);
      });
    },
    tracking: function () {},
...
function (a, b, c, d) {
  function f(b, c) {
    this.element = b, this.options = a.extend(!0, {}, h, c), this.options.share = c.share, this._defaults = h, this._name = g, this.platforms = {}, this.init();
  }
  ...
  f.prototype.init = function () {
    ...
    a.each(b.options.share, function (a, c) {
    ...
    }) : "" !== b.options.template && (b.renderer(), b.options.count[name] = 0, b.rendererPerso()), "" !== b.options.template ? this.options.render(this, this.options) : this.loadButtons(), a(this.element).on("mouseenter", function () {
      ...
      return a.preventDefault(), b.options.click(b, b.options), !1;
    });
    ...
    this.platforms[a].popup(this.options), this.options.enableTracking === !0 && (infos = this.platforms[a].trackingAction, _gaq.push(["_trackSocial", infos.site, infos.action]));
