    ...
    42: [function (t, e, n) {
      ...
      var i = {
        ...
        each: function (t, e, n, a) {
          var o, r, l;
          if (i.isArray(t)) {
            if (r = t.length, a) for (o = r - 1; o >= 0; o--) e.call(n, t[o], o);else for (o = 0; o < r; o++) e.call(n, t[o], o);
          } else if (i.isObject(t)) for (r = (l = Object.keys(t)).length, o = 0; o < r; o++) e.call(n, t[l[o]], l[o]);
        },
        ...
        var e = t.Scale.extend({
          ...
          determineDataLimits: function () {
            ...
            for (t = 0, n = (d.data.datasets || []).length; t < n; ++t) if (d.isDatasetVisible(t)) {
              if (r = d.data.datasets[t].data, x.isObject(r[0])) for (p[t] = [], e = 0, o = r.length; e < o; ++e) l = u(r[e], s), g.push(l), p[t][e] = l;else g.push.apply(g, v), p[t] = v.slice(0);
            } else p[t] = [];
